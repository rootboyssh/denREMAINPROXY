...
# Перенаправляем вывод в лог и на экран с помощью tee
...
# Интерактивный ввод параметров (без запроса IPv6-пула)
get_user_input() {
...
# Обработка аргументов (оставляем как есть)
...
# Функции управления процессами, установки и проверки
